...
class ReleaseOrderApiViewSet(BaseModelViewSet):
    ...
    filter_backends = [filters.SearchFilter]
    search_fields = ['status', 'number', 'creation_date', 'release_date', 'release_date_text', 'employee', 'employeeObj', 'issued_by', 'issued_byObj', 'client_to_bill', 'clientBillObj', 'carrier', 'main_carrierObj', 'warehouse_receipt', 'warehouseReceiptObj',  'consignee','pro_number', 'tracking_number', 'purchase_order_number', 'commodities']
