...
class Carrier(models.Model):
    ...
    type_person = models.CharField(
        max_length=200, blank=True, null=True, default="Carrier"
    )
...
class Agent(models.Model):
    ...
    zip_code = models.CharField(max_length=200, blank=True, null=True)
    type_person = models.CharField(
        max_length=200, default="agent", blank=True, null=True
    )
...
class Vendor(models.Model):
    ...
    zip_code = models.CharField(max_length=200, blank=True, null=True)
    type_person = models.CharField(
        max_length=200, default="vendor", blank=True, null=True
    )
...
class Employee(models.Model):
    ...
    zip_code = models.CharField(max_length=200, blank=True, null=True)
    type_person = models.CharField(
        max_length=200, default="employee", blank=True, null=True
    )
...
class Port(models.Model):
    ...
    type_person = models.CharField(
        max_length=200, default="port", blank=True, null=True
    )
