    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type_person",
                    models.CharField(
                        blank=True, default="agent", max_length=200, null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type_person",
                    models.CharField(
                        blank=True, default="Carrier", max_length=200, null=True
                    ),
                ),
                ("disabled", models.BooleanField(default=False)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type_person",
                    models.CharField(
                        blank=True, default="customer", max_length=200, null=True
                    ),
                ),
                ("disabled", models.BooleanField(default=False)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type_person",
                    models.CharField(
                        blank=True, default="employee", max_length=200, null=True
                    ),
                ),
                ("disabled", models.BooleanField(default=False)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type_person",
                    models.CharField(
                        blank=True, default="port", max_length=200, null=True
                    ),
                ),
                ("disabled", models.BooleanField(default=False)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type_person",
                    models.CharField(
                        blank=True, default="vendor", max_length=200, null=True
                    ),
                ),
                ("disabled", models.BooleanField(default=False)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.JSONField(blank=True, null=True)),
                ('disabled', models.BooleanField(default=False)),
                ('agent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='supplier_agent', to='maintenance.agent')),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='supplier_customer', to='maintenance.customer')),
                ('vendor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='supplier_vendor', to='maintenance.vendor')),
            ],
        ),
        migrations.CreateModel(
            name="ReleasedTo",
