    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carriVerndorByName', models.CharField(blank=True, max_length=200, null=True)),
                ('paymentByDesc', models.CharField(blank=True, max_length=200, null=True)),
                ('billCharges', models.JSONField(blank=True, null=True)),
                ('disabled', models.BooleanField(default=False)),
                ('carriVerndorById', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='maintenance.vendor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customerByName', models.CharField(blank=True, max_length=200, null=True)),
                ('amountReceived', models.DecimalField(blank=True, decimal_places=2, max_digits=9, null=True)),
                ('trasaDate', models.DateTimeField(blank=True, null=True)),
                ('number', models.CharField(blank=True, max_length=200, null=True)),
                ('memo', models.CharField(blank=True, max_length=200, null=True)),
                ('accountByType', models.CharField(blank=True, max_length=200, null=True)),
                ('accountRecei', models.CharField(blank=True, max_length=200, null=True)),
                ('accountByBankType', models.CharField(blank=True, max_length=200, null=True)),
                ('accountReceiBank', models.CharField(blank=True, max_length=200, null=True)),
                ('disabled', models.BooleanField(default=False)),
                ('accountByBankId', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='accountByBankId', to='accounting.chartaccounts')),
                ('accountById', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='accounting.chartaccounts')),
                ('customerById', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='maintenance.customer')),
            ],
        ),
    ]
